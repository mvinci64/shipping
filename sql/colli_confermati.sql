...
--
-- Un collo = uno scatolone della cartonizzazione (stesso indice stampato
-- sull'etichetta scatolone e codificato nel suo barcode Code128,
-- "{order_number}-{indice:02d}" — vedi labels.make_carton_summary_labels_pdf).
-- Il reparto scansiona il barcode a fine linea per confermare che quel
-- collo è stato fisicamente chiuso e pronto: prima di questa conferma,
-- la spedizione non andrebbe confermata (POST /spedizioni/{id}/conferma
-- ha effetto reale, costo e ritiro reali).
--
...
-- dall'API a ogni scansione, così un indice fuori range viene rifiutato
...
-- Il vincolo UNIQUE deve rifiutare una doppia scansione dello stesso collo:
